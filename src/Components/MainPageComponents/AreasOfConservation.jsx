      ...
      <div className="w-full flex flex-col justify-content items-center">
        <div className="my-10 w-11/12 gap-12 flex-wrap flex justify-center items-center">
          {areas.map((area) => (
            <div
              key={area.id}
              className="w-96 md:w-[23rem] lg:w-[25rem]  p-2 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl"
            >
              <div className="p-2">
                <Image src="/an1.svg" alt="" width={500} height={300}></Image>
                <h2 className="font-bold my-4 text-[1.3rem] md:text-[1.5rem] lg:text-[2rem]">
