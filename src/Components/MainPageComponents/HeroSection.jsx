...
//       </Head>
//       <div className=" w-[60px] h-50 py-5">
...
//           className={`${
//             styles.header
//           } ${"min-w-[300px] max-w-[500px] font-semibold text-[#418d89]"}`}
//         >
//           GGV
//         </h3>
...
//         </p><br></br>
//         <p className="md:text-xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus...</p>
//         <button className="bg-[#000107] md:bg-[#418d89] rounded-sx border border-[#418d89] mt-8 mb-3 py-1">
//           <Link href="#joinUs">
  ...
  return (
    <div className="text-white h-[100vh]">
      ...
      <div className="ml-[1.2rem] md:ml-[5rem] lg:ml-[5rem] mt-[8vh]">
        ...
        <p className="md:text-xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus...</p>
        <button className="bg-[#000107] md:bg-[#418d89] rounded-sm border border-[#418d89] mt-12 mb-3 py-1">
          <Link href="#Apply">
            <a className="p-6 text-xl md:text-2xl">Apply for the Visa</a>
          </Link>
        </button>
