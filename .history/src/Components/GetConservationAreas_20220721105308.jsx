...
const GetConservationAreas = () => {
  ...
  return (
    <div className="bg-cover text-red grid grid-col-1 md:grid-cols-2 2xl:h-[100vh]">
      ...
      <div className=" flex-row  bg-[url('/apply_for_visa_bg.png')] bg-cover bg-no-repeat bg-center md:bg-bottom xl:bg-bottom 2xl:bg-center"></div>
    </div>
  );
};
