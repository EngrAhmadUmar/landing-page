  ...
  return (
    <div className="bg-[#faf9f6] font-syne text-black flex flex-col justify-center items-center ">
      <div className="max-w-[90vw]">
        ...
        <div className="">
          <div className="grid grid-cols-1 mt-[4rem] md:grid-cols-2 lg:grid-cols-3 ">
            {areas.map((area) => (
              <div
                key={area.id}
                className="rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl"
              >
                <div className="h-[25rem] w-full">
                  <Image
                    ...
                    // height={300}
                  ></Image>
                  <h2 className="text-2xl font-bold xl:text-4xl max-w-[18rem]">
                    {area.title}
                  </h2>
