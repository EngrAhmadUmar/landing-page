...
const Footer = () => {
  return (
    <div className="bg-[#000107] h-[100vh] text-center font-syne relative sm:px-10 flex flex-col justify-center items-center w-full">
      ...
      <div className="absolute bottom-[20%] flex justify-between w-7/12 m-auto">
      ...
      <div className="text-white font-semibold absolute bottom-3 flex justify-center items-center">
